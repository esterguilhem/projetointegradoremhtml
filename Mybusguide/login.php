...
$email	= $_REQUEST["email"];	//atribuição do campo "email" vindo do formulário para variavel
echo $email;
//$login	= $_POST ["login"];	//atribuição do campo "login" vindo do formulário para variavel
$senha	= $_REQUEST ["senha"];	//atribuição do campo "senha" vindo do formulário para variavel
